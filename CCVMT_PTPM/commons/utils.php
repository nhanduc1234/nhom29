<?php 
    ...
    define('SITE_URL','http://localhost:3000/CCVMT_PTPM/');
    
    $ADMIN_URL = "http://localhost:80/www/CCVMT_PTPM/admin/";
    $AP_URL = "http://localhost:80/www/CCVMT_PTPM/ap/";
    $ADMIN_ASSET_URL = "http://localhost:80/www/CCVMT_PTPM/admin/adminlte/";
